...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  1 18:18:28 2024
...
class HashTable():
    ...
    def __init__(self):
        ...
        self.hashtable = Array(self.size)   # as there are possible hashes
    ...
    def insert(self, element):
        ...
        print("Index of element: ",self.hashtable.search(element))
    ...
    def __str__(self):
        ...
        for element in self.hashtable:
            ...
            if element != None:
                ...
                array_string += ","
                array_string += str(self.hashtable.search(element))
                array_string += ")"
